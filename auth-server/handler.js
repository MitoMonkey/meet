...
/**
 * “process.env” means its a environment variable defined in serverless.yml. 
 * The original value is in the “config.json” file (to keep the API secrets hidden, as config.json is listed in gitignore). 
 */
const credentials = {
  ...
  redirect_uris: ["https://mitomonkey.github.io/meet/"],
  javascript_origins: ["https://mitomonkey.github.io", "http://localhost:3000"],
};
 ...
 * Google and be authorized to see the calendar. After logging in, they’ll receive a code
 * as a URL parameter.
 */
module.exports.getAuthURL = async () => {
  /**
   * Scopes array passed to the `scope` option. Any scopes passed must be enabled in the
   * "OAuth consent screen" settings in the Google Console. Also, any passed
